    ...
    <>
      <div className="hidden sm:block">
        <button
          ...
          className="fixed z-40 bottom-6 right-6 bg-[#C62828] hover:bg-[#C62828] rounded-full flex items-center gap-1 px-4 focus:outline-none cursor-pointer shadow-lg border border-white"
        >
          <span className="flex items-center justify-center rounded-full bg-[#C62828] h-12 w-12 mr-0">
            <img
              src="/book-free-appointment/Images/message.webp"
      ...
      <div className="hidden sm:block">
        <a
          ...
          className="fixed z-40 bottom-6 left-6 rounded-full flex items-center gap-2 px-4 py-2 focus:outline-none bg-[#2143D1] hover:bg-[#1a36ab] cursor-pointer text-white shadow-lg border border-white"
        >
          <svg
