...
- Navigate to `public_html/book-free-appointment/` folder
...
### 4. Verify
Visit: `https://www.seedsofinnocens.com/book-free-appointment/`

## Troubleshooting 403 Forbidden Error

### Check 1: `.htaccess` File
- Ensure `.htaccess` file is uploaded in `book-free-appointment/` folder
- File permissions should be `644`
- File should not be named `.htaccess.txt` (must be exactly `.htaccess`)

### Check 2: Folder Permissions
- `book-free-appointment/` folder should have `755` permissions
- All subfolders should have `755` permissions

### Check 3: Index File
- `index.html` must be present in `book-free-appointment/` folder
- File permissions should be `644`
...
```bash
cd public_html/book-free-appointment/
chmod 644 .htaccess
